...
List<TextElement> linkify(String text) {
...
Widget handleEmoji(String input, {TextStyle style}) {
  ...
  return LayoutBuilder(
    builder: (BuildContext context, BoxConstraints constraints) {
      ...
      print("painter.didExceedMaxLines => ${painter.didExceedMaxLines}");
      print("painter.preferredLineHeight => ${painter.height}");

      bool x = painter.didExceedMaxLines;
      return Stack(children: [
        Container(
          constraints: BoxConstraints(maxHeight: painter.height),
          child: RichText(
            textDirection: ui.TextDirection.ltr,
            maxLines: 3,
            text: TextSpan(children: textSpans),
        ...
        Positioned(
            child: x
                ? Container(
                    child: Text("\u2026 Read more", style: kHyperlinkStyle), color: Colors.white)
                : Container(),
            bottom: 0.0,
            right: 0.0)
      ]);
