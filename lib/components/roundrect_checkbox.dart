...
///  * [Switch], a widget with semantics similar to [RoundRectCheckbox].
...
class RoundRectCheckbox extends StatefulWidget {
  ...
  @override
  _RoundRectCheckboxState createState() => _RoundRectCheckboxState();
}

class _RoundRectCheckboxState extends State<RoundRectCheckbox>
...
const double _kEdgeSize = RoundRectCheckbox.width + 2.0;
const Radius _kEdgeRadius = Radius.circular(RoundRectCheckbox.width * 0.2);
